  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className={`absolute inset-0 bg-gradient-to-t from-emerald-500/20 via-transparent to-transparent transition-all duration-800 ${
          isHovered ? 'opacity-100' : 'opacity-0'
        }`} />
        {/* Animated shimmer effect */}
        <div className={`absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-12 transition-transform duration-1200 ease-out ${
          isHovered ? 'translate-x-full opacity-100' : '-translate-x-full opacity-0'
        }`} />
        {/* Enhanced pulse animation on hover */}
        <div className={`absolute inset-0 bg-emerald-400/5 transition-all duration-500 ${
          isHovered ? 'animate-pulse' : ''
        }`} />
        {/* Breathing glow effect */}
        <div className={`absolute inset-0 bg-gradient-to-br from-emerald-300/10 to-blue-300/10 transition-all duration-1000 ${
